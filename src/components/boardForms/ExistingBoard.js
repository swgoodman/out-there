    ...
    return (
      <div>
        <form onSubmit={ this.onSubmit }>
          ...
          <Button className={classes.button} color="secondary" type="submit">Join</Button>
        </form>
      </div>
    )
  }
...
export default withStyles(styles) (withRouter(connect(null, mapDispatchToProps)(ExistingBoard)))
